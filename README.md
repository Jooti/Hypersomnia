...
# [▶ Play in the Browser!](https://play.hypersomnia.ir/)
...
*Comes with an [in-game map Editor!](https://play.hypersomnia.ir/editor/official)*

# Download the game


| <a href="https://store.steampowered.com/app/2660970/Hypersomnia"> <img src="https://upload.wikimedia.org/wikipedia/commons/8/83/Steam_icon_logo.svg" width=100 hspace=1> </a> | <a href="https://hypersomnia.ir/builds/latest/Hypersomnia-for-Windows.zip"> <img src="https://hypersomnia.ir/assets/images/windows_icon.svg" width=75 hspace=1></a> | <a href="https://hypersomnia.ir/builds/latest/Hypersomnia.AppImage"> <img src="https://hypersomnia.ir/assets/images/linux_icon.svg" width=100 hspace=0 vspace=20></a> | <a href="https://hypersomnia.ir/builds/latest/Hypersomnia-for-MacOS.dmg"> <img src="https://upload.wikimedia.org/wikipedia/commons/2/22/MacOS_logo_%282017%29.svg" width=80 hspace=1 vspace=20></a> |
|:--:|:--:|:--:|:--:|
| [Steam](https://store.steampowered.com/app/2660970/Hypersomnia) | [Windows](https://hypersomnia.ir/builds/latest/Hypersomnia-for-Windows.zip) | [Linux](https://hypersomnia.ir/builds/latest/Hypersomnia.AppImage) | [macOS](https://hypersomnia.ir/builds/latest/Hypersomnia-for-MacOS.dmg) |
...
| <a href="https://hypersomnia.ir/builds/latest/Hypersomnia-for-Windows.zip"> <img src="https://hypersomnia.ir/assets/images/windows_icon.svg" width=75 hspace=1></a> | <a href="https://hypersomnia.ir/builds/latest/Hypersomnia.AppImage"> <img src="https://hypersomnia.ir/assets/images/linux_icon.svg" width=100 hspace=1 vspace=20></a> | <a href="https://hypersomnia.ir/builds/latest/Hypersomnia-for-MacOS.dmg"> <img src="https://upload.wikimedia.org/wikipedia/commons/2/22/MacOS_logo_%282017%29.svg" width=80 hspace=1 vspace=20></a> |
|:--:|:--:|:--:|
| **Windows** | **Linux** | **macOS** |
...
<a href="https://hypersomnia.ir/builds/latest/Hypersomnia-for-Windows.zip"> <img src="https://hypersomnia.ir/assets/images/windows_icon.svg" width=75 hspace=1></a>
<a href="https://hypersomnia.ir/builds/latest/Hypersomnia.AppImage"> <img src="https://hypersomnia.ir/assets/images/linux_icon.svg" width=100 hspace=1 vspace=20></a>
<a href="https://hypersomnia.ir/builds/latest/Hypersomnia-for-MacOS.dmg"> <img src="https://upload.wikimedia.org/wikipedia/commons/2/22/MacOS_logo_%282017%29.svg" width=80 hspace=1 vspace=20></a>
<br undefined>
-->
...
Or download <a href="https://hypersomnia.ir/builds/latest/Hypersomnia-Headless.AppImage"> <img src="https://hypersomnia.ir/assets/images/linux_icon.svg" width=30 hspace=5 vspace=15><b>Server AppImage</b></a>

<sup>*All archives are [digitally signed.](https://github.com/TeamHypersomnia/Hypersomnia/blob/master/src/signing_keys.h) You can [verify signatures.](https://hypersomnia.ir/builds/latest/)*</sup>
...
Today, we have **[24 unique firearms](https://hypersomnia.ir/weapons)**, **[10 community maps](https://hypersomnia.ir/arenas)**, and two game modes: *Bomb defusal* and *Gun game*.
...
- Networking is based on **cross-platform simulation determinism**. It is 100% deterministic **even across browser** ***and*** **native clients** (Windows, Linux, MacOS) and that includes **native ARM builds (aarch64)!**
  ...
  - Another magical trick was needed to ensure the **physics itself is fully deterministic:**
    ...
    - My solution was one of the greatest stroke of epiphany I ever experienced:
      ...
      - I apply the same principle in many other areas of networking. Throughout my codebase, I call this process *[cache reinference.](https://wiki.hypersomnia.ir/reinference)*
...
- Browser clients and native clients **can play on the same servers**, thanks to [libdatachannel](https://github.com/paullouisageneau/libdatachannel) and [datachannel-wasm](https://github.com/paullouisageneau/datachannel-wasm).
  - You can [host a server in the browser](https://play.hypersomnia.ir/host) and connect to it with a native client...
  - ...and vice versa: host a server in the native client and send anyone the link to join from the browser!
- In the browser version, you can **sign in with Discord** and play ranked matches to compete on the [global Leaderboards](https://hypersomnia.ir/leaderboards)!
  - You can also [associate your Discord account with Steam account](https://hypersomnia.ir/profile) so that the Steam version and web version **share the same rating!**
...
- Built-in self-updater: the game will download and apply updates automatically.
    ...
    - Not only that, [it will verify](https://github.com/TeamHypersomnia/Hypersomnia/blob/master/src/application/main/verify_signature.h) that the update came from the hardcoded [developer public key](https://github.com/TeamHypersomnia/Hypersomnia/blob/master/src/signing_keys.h), with a call to ``ssh-keygen``.
      - If the [build hosting](https://hypersomnia.ir/builds/latest/) were hacked and a malicious game version uploaded, the existing game clients **will refuse** to apply the updates.
...
- And speaking of the Editor.. 
  ...
  - It paid off big time - there is now a neat [catalogue of community maps](https://hypersomnia.ir/arenas) - every one of them downloadable.
...
A WIP documentation can be found at [wiki](https://wiki.hypersomnia.ir).
