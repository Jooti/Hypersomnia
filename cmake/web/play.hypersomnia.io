server {
    server_name play.hypersomnia.ir www.play.hypersomnia.ir;
    ...
    ssl_certificate /etc/letsencrypt/live/play.hypersomnia.ir/fullchain.pem; # managed by Certbot
    ssl_certificate_key /etc/letsencrypt/live/play.hypersomnia.ir/privkey.pem; # managed by Certbot
...
server {
    if ($host = www.play.hypersomnia.ir) {
        return 301 https://$host$request_uri;
    } # managed by Certbot

    if ($host = play.hypersomnia.ir) {
        return 301 https://$host$request_uri;
    } # managed by Certbot
